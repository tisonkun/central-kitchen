...
指标分开成两类来讨论，是因为其关注点和实际执行人员的不同表现出来的差异。

2C 运营模式讲的是在“社区运营”这个概念火起来以后，装在这个袋子里泥沙俱下的运营人员的实践。传统 KPI 指标讲的是落到项目开发人员头上的“开源工程效能”和“社区活跃程度”类指标。

2C 运营模式一脉相承自当年遍地黄金如今增长缓慢的消费者市场营销，其基本假设是运营对象都是傻瓜（无贬义，即对人的智能的最少假设），通过直接利益交换营销指标，尤其是人头数，点击数一类的氛围型指标。换句话说，搞出气氛，数字好看就算成功。

这种模式下典型的两个案例是**集赞**和**PR 比赛**。

前一个例子不展开了，很典型的是把运营对象当成傻瓜，凑人头刷一个数据搞气氛。过去一段时间应该有不少文章分析过，其实做出来的数字跟社区当中创造价值毫无关联。

后一个例子有好几种变体，也就是好的社区千篇一律，不好的实践千奇百怪。我也不用给他们宣传，就挑一个讲。

这个最典型的就是故意留 BUG 凑人头“修复”。而且还是那种加个 linter 写个脚本就能持续集成解掉的问题。为了运营，我不这么干了。我非要留几个没写过代码的人也能照猫画虎搞个“贡献”的坑，看见了也不去修，就等着交给运营人员去刷数，甚至我亲自写脑残 BUG 给人修。

这种玩意真的异常尴尬，不要解释是为了降低门槛还是鼓励参与，开源软件社区的目的是制造出好的软件，不是闹哄哄的来一堆人假模假样的“参与”。如果为了运营能背弃软件工程的最佳实践，那么毫无疑问这是为了运营而运营。这样吸引来的 contributor 也不会是真正有热情参与 community 的，而大概率是干一票跑路的投机者。

在关注开源软件的开发者群体里，是完全看不起这种混一个 PR 换一个马克杯或者某种周边的公司的。如此运营，恐怕还有负面效果。唱赞歌的人也不过是为了忽悠运营接着撒币罢了。

## 2C 运营模式的运用

那么，话又说回来，单看一个 PR 的 contribution 也是中性的。虽然运营的手段从整体结果来看是坏的，但是单独的 contribution 无论如何对开源社区来说是有价值的。

我在 COSCon'21 的主题[《Why Contributors Stay and Grow》](https://www.bilibili.com/video/BV1Tg411K7KS/)上也提到过 2C 运营模式的运用姿势。它被归结为调动 contributor 直接激励的参与动机的手段。

类似 GSoC 或 Hacktoberfest 这种活动，在不侵入项目正常开发的情况下，鼓励参与者投入到开源软件社区正常的价值创造中，仅由于有活动提供了一个引子连接起新成员与其他社区成员的关系。这种通过直接激励引导入门，在参与和价值创造中积累起社会资本并逐渐深入的模式，对社区是有益的。

它和上面提到的 PR 换周边的根本区别就在于动机和行为。好的直接激励是以社区的价值创造为本，通过活动加速及支持这个过程。投机的方式从活动参与者到运营人员到被迫参与的公司员工（此时甚至不戴社区成员的帽子）都是为了那个利益展开活动，彼此看不起还要假装融洽相处，一旦利益交换完成，关系立即分崩离析。不是说结果都是参与 contribute 了，吸引到人来了就是一样的。这种动机的差别会营造出截然不同的社区氛围，身处其中的人能够明显的感觉到其中的差别，并在诸多小事上有所体现。

总结来说，2C 运营模式在面向开发者（2D）的环境下，只能归结为直接激励的模式，并且在实践中遵守辅助参与的角色，不应该喧宾夺主。新成员进入社区后，需要强大的社区引力吸引他到一个适合 contribute 的领域继续深入。当然，除了拉新也存在现有社区成员参与活动的情况，但是因为活动本身建立在开源软件社区正常的价值创造中，这并不需要额外注意。最后，2C 运营模式下的直接激励一般价值不高，不应该过度包装，否则会掉进低估 contribution 的陷阱，起反作用。对这种模式能够为社区发展创造的价值，也不用抱太大希望。

2C 运营模式我实际上并没有做深入的研究，但是其显而易见的问题太多，也是近期不稳定的“引爆点”，所以单独讨论两小段。

## 传统 KPI 指标的问题

摊派到开发人员头上的传统 KPI 指标的问题，一言以蔽之，是**没有理解组织想在开源项目社区当中寻求什么**。

同样，在讨论这个问题的解法之前，我们介绍几个典型的传统 KPI 指标。
