...
后一个例子有好几种变体，也就是好的社区千篇一句，不好的实践千奇百怪。我也不用给他们宣传，就挑一个讲。

这个最典型的就是故意留 BUG 凑人头“修复”。而且还是那种加个 linter 写个脚本就能持续继承掉的问题。为了运营，我不这么干了。我非要留几个没写过代码的人也能照猫画虎搞个“贡献”的坑，看见了也不去修，就等着交给运营人员去刷数，甚至我亲自写脑残 BUG 给人修。
